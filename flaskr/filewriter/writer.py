...
class Writer:
    ...
    def writebook(self):
        ...
        variablecolumns = [14 + n for n in range(8)] #this will be 12 with inflection RFUs
        ...
        for group in range(1, int(adf['group'].max()) + 1):
            ...
            for inf in range(4):
                columns.append(22+inf) #TODO: 26 when inflections
                inf_label = 'Inflection ' + str(inf + 1)
                gdf.insert(22+inf, 'Difference from control ' + str(inf + 1), adf[inf_label] - float(control[inf_label]))
        ...
        for group in range(1, int(adf['group'].max()) + 1):
            for inf in range(4):
                ...
                for triplicateA in gdf['triplicate'].unique():
                    ...
                    gdf.insert(len(gdf.columns), str(triplicateA) + ' ' + inf_label,
    ...
    def excel_formatting(self, sheetname, df):
        ...
        for idx, column in enumerate(df.columns):
            ...
            worksheet.set_column(idx, idx+1, maxlength)
